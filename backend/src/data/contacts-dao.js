...
export async function createContact(contact) {
  ...
  //don't need to check, database will handle exceptions....
...
export async function updateContact(id, contact) {
  ...
  const c = await Contact.findByIdAndUpdate(id, contact); //will find contact with matching id + update if exists

  return !!c; //if c is an actual object then will return true, null then return false
